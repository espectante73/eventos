...
### 2.3 2026-08-25 (quinta tanda): acordeón de una sola + límite real explicado (WhatsApp)
...
### 2.4 2026-08-25 (sexta tanda): bug real -- los buckets de Storage llevaban vacíos desde que se crearon (v6.6)
...
### 2.5 2026-08-25 (séptima tanda): el botón "Enlace" copiaba lo de antes, no el enlace nuevo
...
### 2.6 2026-08-25 (octava tanda): el reordenado no bastó -- causa raíz de verdad
...
### 2.7 2026-08-25 (novena tanda): pregunta de acceso al tablón (v6.7)
...
### 2.8 Ventana "Aniversarios" y las fotos fuera de la base (2026-09-17, v30)
...
### 2.9 Pendiente: hacer el mapa del sitio privado de verdad (aparcado el 2026-09-16)
...
### 2.10 "Mapa del sitio" en Mi cuenta, con permiso propio (2026-09-16, v29)
...
### 2.11 El Modo Pruebas no guardaba Novedades (2026-09-17)
...
### 2.12 No se podía salir del Modo Pruebas (2026-09-20, v37.13)
...
### 2.13 "Autorizo expresamente a que guarden mis datos" (2026-09-21, v39.2)
...
### 2.14 "Todavía no hay fecha confirmada" (2026-09-21, v39)
...
### 2.15 Dos clases de permiso, no una (2026-09-21, v38.5)
...
### 2.16 El mapa se quedaba viejo sin que nadie se enterara (2026-09-23)
...
### 2.17 El acabado, con una escala y no a ojo (2026-09-20, v38)
...
### 2.18 El sello que late (2026-09-20, v38.1)
...
### 2.19 Se acabaron los avisos del navegador (2026-09-20, v37.12)
...
### 2.20 "Datos X de Y": completo es siempre N de N (2026-09-19, v37.5)

### 2.21 Una familia no se separa en las mesas (2026-09-19, v37)
...
### 2.22 Relieve, clic y pregunta de seguridad (2026-09-19, v36)
...
### 2.23 Permiso "Ver el código de la app" (2026-09-18, v34.2)
...
### 2.24 Peso de la app: de 1.196 KB a 443 KB al abrir (2026-09-18, v34.1)
...
### 2.25 Deshacer de verdad, y fuera las copias en JSON (2026-09-17, v34)
...
### 2.26 `schema.sql` reescrito desde cero (2026-09-16)
...
### 2.27 2026-09-06 (v24): agujero real de escritura anónima, encontrado y cerrado
...
### 2.28 2026-09-06/07 (v24.2): retirado el enlace ?rol= y rotado el token
